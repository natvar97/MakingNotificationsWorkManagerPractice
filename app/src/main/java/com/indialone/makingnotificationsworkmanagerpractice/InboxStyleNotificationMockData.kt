...
object InboxStyleNotificationMockData {
    ...
    fun mIndividualEmailSummary(): ArrayList<String> {
        ...
        list.add("Natu  -   Launch Party is here...")
        list.add("Alan Walker -   There's a turtle on the server!")
        list.add("Uru -   Check this out...")
        list.add("Hardy -   Check in code?")
        list.add("Mihir -   Movies later....")
